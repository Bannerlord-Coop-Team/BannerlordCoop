...
using GameInterface.Services.Issues.Generic.PartySpawn;
...
public class GameInterfaceModule : Module
{
    ...
    protected override void Load(ContainerBuilder builder)
    {
        ...
        builder.RegisterType<LocationKeyedInstanceResolution>().As<ILocationKeyedInstanceResolution>().InstancePerDependency();
        builder.RegisterType<OwnershipKeyedInstanceResolution>().As<IOwnershipKeyedInstanceResolution>().InstancePerDependency();
