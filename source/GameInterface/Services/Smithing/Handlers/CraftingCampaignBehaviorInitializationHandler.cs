...
internal class CraftingCampaignBehaviorInitializationHandler : IHandler
{
        ...
        ISessionCraftingPlayerDataInterface sessionCraftingPlayerDataInterface)
    {
        ...
        messageBroker.Subscribe<InitializeClientCraftingData>(Handle_InitializeClientCraftingData);
        messageBroker.Subscribe<PlayerHeroChanged>(Handle_PlayerHeroChanged);
        messageBroker.Subscribe<NetworkInitializeServerCraftingDataKeys>(Handle_NetworkInitializeServerCraftingDataKeys);
    }

    public void Dispose()
    {
        messageBroker.Unsubscribe<InitializeClientCraftingData>(Handle_InitializeClientCraftingData);
        messageBroker.Unsubscribe<PlayerHeroChanged>(Handle_PlayerHeroChanged);
        messageBroker.Unsubscribe<NetworkInitializeServerCraftingDataKeys>(Handle_NetworkInitializeServerCraftingDataKeys);
    }

    private void Handle_InitializeClientCraftingData(MessagePayload<InitializeClientCraftingData> obj)
    {
    ...
    private void Handle_NetworkInitializeServerCraftingDataKeys(MessagePayload<NetworkInitializeServerCraftingDataKeys> obj)
    {
        GameThread.RunSafe(() =>
        {
