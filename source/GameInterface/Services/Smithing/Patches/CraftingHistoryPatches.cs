...
internal class AddItemToHistoryPatch
{
    ...
    [HarmonyPatch(nameof(CraftingCampaignBehavior.AddItemToHistory))]
    [HarmonyPrefix]
    public static bool AddItemToHistoryPrefix(ref CraftingCampaignBehavior __instance, ItemObject craftedObject)
    {
    ...
    public static void OverrideAddItemToHistory(ref CraftingCampaignBehavior __instance, ItemObject craftedItem)
    {
        ...
        var message = new UpdateCraftedItemHistory(Hero.MainHero, __instance._cratingItemsHistory);
...
{
    [HarmonyPatch(nameof(CraftingHistoryVM.RefreshCraftingHistory))]
    [HarmonyPrefix]
    public static bool RefreshCraftingHistoryPrefix(CraftingHistoryVM __instance)
    {
