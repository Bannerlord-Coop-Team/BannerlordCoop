...
public class MobilePartyFieldPatches
{
    ...
    */
    ...
    {
        var field = AccessTools.Field(typeof(MobileParty), nameof(MobileParty._partyComponent));
        var fieldIntercept = AccessTools.Method(typeof(MobilePartyFieldPatches), nameof(PartyComponentIntercept));
    ...
    public static void PartyComponentIntercept(MobileParty instance, PartyComponent newPartyComponent)
    {
        if (CallOriginalPolicy.IsOriginalAllowed())
        {
            instance._partyComponent = newPartyComponent;
            return;
        }
        if (ModInformation.IsClient)
        {
        ...
        if (partyComponentRegistry.TryGetId(newPartyComponent, out var componentId) == false)
        {
