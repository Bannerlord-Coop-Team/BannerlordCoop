...
namespace GameInterface.Services.Towns.Messages.Collections
{
    ...
    internal record NetworkBuildingsRemoved : GenericNetworkReferenceEvent<Town, Building>
    {
        [ProtoMember(1)]
        ...
        public NetworkBuildingsRemoved(string townId, string buildingId) : base(townId, buildingId)
        {
        }
    }
}
