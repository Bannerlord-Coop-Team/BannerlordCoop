...
namespace GameInterface.Services.Towns.Messages.Collections
{
    ...
    internal record NetworkBuildingsAdded : GenericNetworkReferenceEvent<Town, Building>
    {
        [ProtoMember(1)]
        ...
        public NetworkBuildingsAdded(string townId, string buildingId) : base(townId, buildingId)
        {
        }
    }
}
