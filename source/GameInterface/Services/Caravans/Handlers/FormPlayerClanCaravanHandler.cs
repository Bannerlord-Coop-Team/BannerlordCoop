...
internal class FormPlayerClanCaravanHandler : IHandler
{
        ...
        INetwork network)
    {
        ...
        messageBroker.Subscribe<NetworkFormPlayerClanCaravan>(Handle_NetworkFormPlayerClanCaravan);
        messageBroker.Subscribe<NetworkFadeOutNewCaravanLeader>(Handle_NetworkFadeOutNewCaravanLeader);
    }

    public void Dispose()
    {
        messageBroker.Unsubscribe<FormPlayerClanCaravan>(Handle_FormPlayerClanCaravan);
        messageBroker.Unsubscribe<NetworkFormPlayerClanCaravan>(Handle_NetworkFormPlayerClanCaravan);
        messageBroker.Unsubscribe<NetworkFadeOutNewCaravanLeader>(Handle_NetworkFadeOutNewCaravanLeader);
    }
    ...
    private void Handle_FormPlayerClanCaravan(MessagePayload<FormPlayerClanCaravan> obj)
    {
        ...
        var message = new NetworkFormPlayerClanCaravan(mainHeroId, caravanLeaderId, currentSettlementId, obj.What.IsElite, obj.What.ShouldCreateConvoy, obj.What.GoldCost);
    ...
    private void Handle_NetworkFormPlayerClanCaravan(MessagePayload<NetworkFormPlayerClanCaravan> obj)
    {
        ...
        GameThread.Run(() =>
        {
            ...
            // Send message to all clients to fade out the caravan leader character if present in their current mission
            network.SendAll(new NetworkFadeOutNewCaravanLeader(obj.What.CaravanLeaderId));
        });
    }
