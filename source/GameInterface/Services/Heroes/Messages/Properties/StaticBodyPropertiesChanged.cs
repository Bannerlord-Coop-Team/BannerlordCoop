...
public class StaticBodyPropertiesChanged : IEvent
{
    public StaticBodyPropertiesChanged(string id, string target, ulong keyParty1, ulong keyParty2, ulong keyParty3, ulong keyParty4, ulong keyParty5, ulong keyParty6, ulong keyParty7, ulong keyParty8)
    {
        Id = id;
        Target = target;
        KeyParty1 = keyParty1;
