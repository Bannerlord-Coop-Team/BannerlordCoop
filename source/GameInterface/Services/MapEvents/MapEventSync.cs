...
internal class MapEventSync : IDynamicSync
{
    public MapEventSync(DynamicSyncRegistry autoSyncBuilder)
    {
        ...
        autoSyncBuilder.AddProperty(AccessTools.Property(typeof(MapEvent), nameof(MapEvent.TroopUpgradeTracker)));

        autoSyncBuilder.AddField(AccessTools.Field(typeof(MapEvent), nameof(MapEvent.MapEventVisual)));
