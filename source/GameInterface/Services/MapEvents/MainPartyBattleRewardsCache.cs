...
internal interface IMainPartyBattleRewardsCache
{
    void Capture(MapEvent mapEvent, MapEventParty mapEventParty, float contributionRate);

    bool TryGet(MapEvent mapEvent, out ExplainedNumber renown, out ExplainedNumber influence,
...
// live.
internal class MainPartyBattleRewardsCache : IMainPartyBattleRewardsCache
{
    ...
    public void Capture(MapEvent mapEvent, MapEventParty mapEventParty, float contributionRate)
    {
    ...
    public bool TryGet(MapEvent mapEvent, out ExplainedNumber renown, out ExplainedNumber influence,
        out ExplainedNumber morale, out float contributionRate)
    {
