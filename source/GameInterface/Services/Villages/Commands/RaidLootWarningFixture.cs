...
public sealed class RaidLootWarningFixture : IRaidLootWarningFixture
{
    ...
    public CoopCommandResult ReadState(string controllerId)
    {
        ...
        return Succeeded(new
        {
            ...
            partyBaseIsActive = party.Party.IsActive,
            partyIsMoving = party.IsMoving,
            partyHasArmy = party.Army != null,
            partyHasMapEvent = party.MapEvent != null,
            partyBesiegedSettlementId = party.BesiegedSettlement?.StringId,
            partyIsCurrentlyAtSea = party.IsCurrentlyAtSea,
            villageHasMapEvent = settlement.Party.MapEvent != null,
            villageIsUnderSiege = settlement.IsUnderSiege,
            boundTownIsUnderSiege = settlement.Village.Bound.IsUnderSiege,
