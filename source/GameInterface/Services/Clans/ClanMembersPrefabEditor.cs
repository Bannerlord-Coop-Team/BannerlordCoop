...
public class ClanMembersPrefabEditor : IClanMembersPrefabEditor
{
    public void AddMemberGroups(XmlNode root)
    {
        ...
        AddGroup(root, "Players");
        AddGroup(root, "OtherFamilies");
    ...
    private void AddGroup(XmlNode root, string group)
    {
        ...
        var before = root.SelectSingleNode(".//NavigationAutoScrollWidget[@TrackedWidget='..\\CompanionsHeader']");
        ...
        var companionToggle = root.SelectSingleNode(".//*[@Id='CompanionsToggleButton']");
        companionToggle.ParentNode.InsertBefore(CloneGroup(toggle, group, "IsRelevant"), companionToggle);
    }
