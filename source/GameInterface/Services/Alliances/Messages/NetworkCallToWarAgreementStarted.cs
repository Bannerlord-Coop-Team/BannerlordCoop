...
public readonly struct NetworkCallToWarAgreementStarted : ICommand
{
    [ProtoMember(1)]
    ...
    public NetworkCallToWarAgreementStarted(string callingKingdomId, string calledKingdomId, string kingdomToCallToWarAgainstId)
    {
