...
public static class AbsentOwnerEvaluationSupport
{
    public static bool TryEvaluateOnBehalfOfAbsentOwner(Hero questGiver, Action<string> evaluate)
    {
        ...
        if (!ContainerProvider.TryResolve<IPlayerManager>(out var playerManager) ||
            ...
            (playerManager.IsConnected(player) && playerManager.IsCampaignReady(player))) return false;
