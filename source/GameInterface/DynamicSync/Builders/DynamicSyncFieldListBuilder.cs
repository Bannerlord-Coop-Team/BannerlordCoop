...
namespace GameInterface.DynamicSync.Builders
{
    public class DynamicSyncFieldListBuilder : DynamicSyncBuilderBase
    {
        ...
        public DynamicSyncFieldListBuilder(IObjectManager objectManager, DynamicSyncRegistry dynamicSyncRegistry, DynamicSyncConstantsBuilder dynamicSyncConstantsBuilder) : base(dynamicSyncRegistry, dynamicSyncConstantsBuilder)
        {
