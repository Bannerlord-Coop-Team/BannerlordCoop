...
public class AutoSyncFieldMBListBuilder : AutoSyncBuilderBase
{
    public AutoSyncFieldMBListBuilder(
    ...
    public string GetTranspiler(Debuggable<FieldInfo> fieldItem)
    {
        ...
        string changeTemplate = TemplateParser.Parse("Patches.FieldMBListChangeTranspilerTemplate", GetTemplateData(fieldItem));
