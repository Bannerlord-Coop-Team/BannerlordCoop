...
namespace GameInterface.AutoSync.Builders
{
    public class AutoSyncPropertyQueueBuilder : AutoSyncBuilderBase
    {
        ...
        public IEnumerable<string> GetMessages(Debuggable<PropertyInfo> propertyItem)
        {
            ...
            AutoSyncConfiguration.ExportFile($"{propertyInfo.DeclaringType.Name}/Local_{propertyInfo.DeclaringType.Name}_{propertyInfo.Name}_QueueClear.cs", localClearMessage);
            AutoSyncConfiguration.ExportFile($"{propertyInfo.DeclaringType.Name}/Network_{propertyInfo.DeclaringType.Name}_{propertyInfo.Name}_QueueClear.cs", networkClearMessage);
