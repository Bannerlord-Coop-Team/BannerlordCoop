...
namespace GameInterface.Missions.Services.Taverns
{
    public class CoopTavernsController : MissionBehavior, ILocationMissionBehavior, IDisposable
    {
        ...
        public override void OnEndMissionInternal()
        {
            ...
            // Announce relay-membership departure to the server (counterpart to PlayerEnteredLocation): a
            // Coop.Core handler turns this into a MissionLeft so the server drops us from the instance's
            // relay routing table.
