...
namespace Coop.Network
{
    ...
    {
        private readonly
            Dictionary<(EConnectionState, Protocol.EPacket), List<PacketHandlerDelegate>>
            m_PacketHandlers =
                new Dictionary<(EConnectionState, Protocol.EPacket), List<PacketHandlerDelegate>>();
        ...
        public void Dispatch(EConnectionState state, Packet packet)
        {
            ...
            (EConnectionState state, Protocol.EPacket Type) key = (state, packet.Type);
        ...
        private void registerPacketHandler(MethodInfo method, object obj)
        {
            ...
            {
                (EConnectionState State, Protocol.EPacket Type) key = (attribute.State,
                    attribute.Type);
