...
public class DefenderSiegeFixtureContractTests
{
    ...
    [Fact]
    public void IsStaged_RequiresTheDefenderPartyInsideOdrysaCastleWithoutSiegeState()
    {
        Assert.True(DefenderSiegeFixtureContract.IsStaged(
            CreateState(currentSettlementId: "castle_ES1"), "castle_ES1"));
        Assert.False(DefenderSiegeFixtureContract.IsStaged(
            CreateState(currentSettlementId: "castle_ES1", hasBesiegerCamp: true), "castle_ES1"));
        Assert.False(DefenderSiegeFixtureContract.IsStaged(
            CreateState(currentSettlementId: "town_ES2"), "castle_ES1"));
    }
