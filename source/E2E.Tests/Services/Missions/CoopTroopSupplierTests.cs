...
public class CoopTroopSupplierTests
{
    ...
    public void ThreePlayers_ReceiveTroopsProportionalToEligibleCounts()
    {
        ...
        largest.SetReserve(new[] { Party("L", 600, isReceiverPlayerParty: true, playerOwnedRank: 0) },
            sideTotal: total, playerOwnedParties: playerParties, allocationMetadataPresent: true);
        ...
        middle.SetReserve(new[] { Party("M", 300, seedBase: 4000, isReceiverPlayerParty: true,
            ...
            allocationMetadataPresent: true);
    ...
    [Fact]
    public void CurrentServer_CanClearThePlayerPartyCount()
    {
        var supplier = new CoopTroopSupplier("M1", BattleSideEnum.Attacker, null, new BattleAgentBudget());
        supplier.SetReserve(new[] { Party("P1", 10, isReceiverPlayerParty: true, playerOwnedRank: 0) },
            sideTotal: 100, playerOwnedParties: 1, allocationMetadataPresent: true);
    ...
    [Fact]
    public void CurrentServer_CanAuthoritativelyClearAnEmptySide()
    {
        var supplier = new CoopTroopSupplier("M1", BattleSideEnum.Attacker, null, new BattleAgentBudget());
        supplier.SetReserve(new[] { Party("P1", 10, isReceiverPlayerParty: true, playerOwnedRank: 0) },
            sideTotal: 10, playerOwnedParties: 1, allocationMetadataPresent: true);
    ...
    public void AllocationSnapshot_RemainsInternallyStable_AfterTheNextGenerationArrives()
    {
        ...
        }, sideTotal: 100, playerOwnedParties: 2, allocationMetadataPresent: true, snapshotRevision: 2);
        ...
        }, sideTotal: 200, playerOwnedParties: 2, allocationMetadataPresent: true, snapshotRevision: 3);
