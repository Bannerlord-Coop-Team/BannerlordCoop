...
public class MobilePartyPropertyTests : SyncTestBase
{
    ...
    public void Server_MobileParty_Properties()
    {
        ...
        TestEnvironment.AssertProperty<MobileParty, bool>(nameof(MobileParty.IsActive), true);
        ...
        TestEnvironment.AssertProperty<MobileParty, bool>(nameof(MobileParty.IsLordParty), true);
