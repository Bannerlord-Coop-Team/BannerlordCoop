...
namespace Coop.Tests.Sync
{
    public class SyncMethod_Test
    {
        ...
        private void IsRegistered()
        {
            ...
            Assert.True(Registry.IdToMethod.ContainsKey(m_SyncedMethod.Id));
            Assert.True(Registry.IdToMethod.ContainsKey(m_StaticSyncedMethod.Id));
        }
        ...
        private void OriginalIsCalledOnInvoke()
        {
            ...
            m_SyncedMethod.Call(EOriginator.RemoteAuthority, instance, new object[] {iExpectedValue});
