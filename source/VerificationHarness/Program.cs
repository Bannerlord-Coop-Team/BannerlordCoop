...
public static class Program
{
    ...
    private static void WriteUsage()
    {
        ...
        Console.Error.WriteLine("  VerificationHarness dedicated-server-synthetic --head <40-hex> --tree <40-hex> --server-head <40-hex> --server-tree <40-hex> --server-pid <pid> --run-token <token> --request-id <id> --join-port <port> [--timeout-ms <milliseconds>] [--seed <non-negative-decimal|0x16-hex>] [--output <json-path>]");
