...
using GameInterface.Missions.Battles;
using GameInterface.Missions.Services.Network;
using GameInterface.Registry;
using MissionTestMod.GameManagers;
using SandBox;
...
namespace GameInterface.Missions.Services.Battles
{
    public class BattlesTestGameManager : SandBoxGameManager, IMissionGameManager
    {
        ...
        private readonly IBattleNetwork _client;
