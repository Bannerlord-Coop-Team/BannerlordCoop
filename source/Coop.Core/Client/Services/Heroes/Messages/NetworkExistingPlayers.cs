...
/// only the registry records that mark them as player-controlled. Without it the joiner would
/// treat other players' parties as AI: the per-player broadcast fires once, at character
/// creation, and a peer that was not yet eligible for broadcasts at that moment never sees it.
/// </summary>
[ProtoContract]
