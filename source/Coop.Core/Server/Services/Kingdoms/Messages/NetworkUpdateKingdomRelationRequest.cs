...
namespace GameInterface.Services.Kingdoms.Messages
{
    ...
    public record NetworkUpdateKingdomRelationApproved : ICommand
    {
        [ProtoMember(1)]
        ...
        public NetworkUpdateKingdomRelationApproved(string clanId, string kingdomId, int changeKingdomActionDetail, 
