...
public class ServerLogic : IServerLogic
{
    ...
    private IReadOnlyDictionary<Type, Func<IServerState>> CreateStateFactories() =>
        ...
        {
            [typeof(InitialServerState)] = () => new InitialServerState(this, context.MessageBroker, context.RegistryManager, context.MapEventLoadCleaner, context.ModuleInfoProvider, context.ModuleValidator, context.GameStateInterface, context.LoadingInterface),
