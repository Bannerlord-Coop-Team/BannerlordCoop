...
public class ConnectionLogic : IConnectionLogic
{
    ...
    private IReadOnlyDictionary<Type, Func<IConnectionState>> CreateStateFactories() =>
        new Dictionary<Type, Func<IConnectionState>>
        {
            ...
            [typeof(LoadingState)] = () => new LoadingState(this, context.MessageBroker, context.Network, context.JoinCampaignBaselineSender, context.JoinCampaignKingdomBaseLineSender, context.ConnectionMessageQueue, context.Coalescer, context.PlayerManager),
