...
namespace Coop.Mod.Missions
{
    public class MissionTestGameManager : SandBoxGameManager
    {
        ...
        public override void OnLoadFinished()
        {
            ...
            //EncounterManager.StartPartyEncounter(MobileParty.MainParty.Party, MobileParty.AllBanditParties.First().Party);

            //Set our encounter to the created encounter
            //PlayerEncounter.LocationEncounter = locationEncounter;

            //Mission mission = SandBoxMissions.OpenBattleMission(new MissionInitializerRecord("battle_terrain_g"));
            //mission.AddMissionBehavior(new MissionNetworkBehavior(m_Client));
