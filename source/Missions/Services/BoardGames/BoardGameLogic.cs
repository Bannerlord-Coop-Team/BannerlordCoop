...
=======
            _messageBroker.PublishAllEvent(pawnCapturedEvent);
>>>>>>> NetworkEvent-refactor
...
=======
            _messageBroker.PublishAllEvent(boardGameMoveEvent);
>>>>>>> NetworkEvent-refactor
        }
...
=======
            _messageBroker.PublishAllEvent(forfeitMessage);
>>>>>>> NetworkEvent-refactor
            Dispose();
        }
