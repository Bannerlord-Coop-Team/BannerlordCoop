...
internal static class BattleDebugCommands
{
    ...
    public static string MovementTraffic(List<string> args)
    {
        ...
        return
            $"fieldBattle={mission.IsFieldBattle} elapsedSeconds={FormatTraffic(traffic.ElapsedSeconds)} " +
            ...
            $"playerPollHz={FormatTraffic(playerHz)} normalPollHz={FormatTraffic(normalHz)} " +
    ...
    private static string FormatTraffic(float value) =>
