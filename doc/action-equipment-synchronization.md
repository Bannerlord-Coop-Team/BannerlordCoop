...
- A deferred former-host action being replaced by the same sender's ordinary snapshot even before registration or host assignment, with authority checked when applying the latest action after its missing weapon arrives.
